...
public class FeatureSetLookup {
    ...
    static {
        ...
        map.put(Feature.ATR, +1.0f);
        map.put(Feature.CTR, -1.0f);
        map.put(Feature.HIGH, +1.0f);
        map.put(Feature.LOW, -1.0f);
        map.put(Feature.BACK, -1.0f);
        ...
        map.put(Feature.LOW, -1.0f);
        map.put(Feature.BACK, +1.0f);
        map.put(Feature.ANTERIOR, -1.0f);
        map.put(Feature.DISTRIBUTED, -1.0f);
        map.put(Feature.LATERAL, -1.0f);
        map.put(Feature.RHOTIC, +1.0f);
        list = new ArrayList<FeatureSet>();
        list.add(new FeatureSet(map));
        ...
        map.put(Feature.NASAL, +1.0f);
        map.put(Feature.BLADE, +1.0f);
        map.put(Feature.HIGH, -1.0f);
        map.put(Feature.LOW, -1.0f);
        map.put(Feature.BACK, -1.0f);
        map.put(Feature.ANTERIOR, +1.0f);
